...
if command == ("quit" || "exit")
	return 0
elsif command == ("south" || "South" || "down" || "Down" || "s" || "S")
...
elsif command == ("north" || "North" || "n" || "N" || "forward" || "Forward" || "up" || "Up")
	puts "	You chose the tiny, little door. You squeeeeeze in.
	You see a small cottage-like house. There is a little 
	Leprechaun in an arm chair. \"What do you thin' you're doin', 
	Laddie?\", he asks you. 
	How do you reply?
		"
		print ">-|-O>"
...
elsif command == ("west" || "West" || "w" || "W" || "left" || "Left")
...
elsif command == ("east" || "East" || "E" || "e" || "right" || "Right")
...
elsif command == ( "Jacob is the best" || "jacob is the best")
